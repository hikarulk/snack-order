...
<meta name="author" content="Hikarulk" />
									...
									<div class="tab">
										...
										<div class="tab-content">
											<div class="tab-content-inner active" data-content="signup">
												...
												<form id="signup" role="form" action="#" class="form-signin" data-toggle="validator">
													<div class="row form-group">
														<div class="col-md-12">
															<label for="username">Username or E-mail</label> <input
																type="text" id="username" class="form-control" data-error="adsfasdfs" required="required">
													...
													<div class="row form-group">
														<div class="col-md-12">
															<input type="submit" class="btn btn-primary btn-block"
																value="Get Started"> <input type="button"
																class="btn btn-default btn-block" value="Sign Up">
														</div>
													</div>
												</form>
											</div>
					...
					<div class="col-md-12 text-center copyright">
						<p>
							<small class="block">&copy; 2016 Free HTML5. All Rights
								Reserved.</small> <small class="block">Designed by <a href=""
								target="_blank">Hikarulk</a></small> <small>Thank you <a
								href="https://GETTEMPLATES.CO">GETTEMPLATES.CO</a></small>
						</p>
					</div>
